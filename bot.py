    ...
    if texto == '/menu':
        ...
        if (from_id ==seu-id):####coloque seu-id
            if len_msg > 1:
                ...
                try:bot.sendMessage(-1001106487387, texto, parse_mode="Markdown")
                except:
                    try:bot.sendMessage(-1001106487387, texto)
...
fale com_ @paulo6'''.format(texto), parse_mode="Markdown")
        ...
        time.sleep(2)
        markup = InlineKeyboardMarkup(inline_keyboard=[[dict(text='🔧suporte', url='https://telegram.me/robotaylor')],[InlineKeyboardButton(text='📃status', callback_data='n')]+[InlineKeyboardButton(text='⚙Comandos', callback_data='edit')]+[InlineKeyboardButton(text='ℹinfo', callback_data='info')]])
...
Deixa eu te fala, você pode entrar em contato com a minha equipe, a (equipe cyon)[t.me/robotaylor], lá eles oferecem suporte rsrs.""".format(msg['from']['first_name']), reply_markup=markup, parse_mode="Markdown")
...
def on_callback_query(msg):
    ...
    if data == 'n':
        ...
        if message_with_inline_keyboard:
            ...
            markup = InlineKeyboardMarkup(inline_keyboard=[[dict(text='🔧suporte', url='https://telegram.me/robotaylor')],[InlineKeyboardButton(text='📃status', callback_data='n')]+[InlineKeyboardButton(text='⚙', callback_data=' ')]+[InlineKeyboardButton(text='ℹinfo', callback_data='info')]])
...
EXEMPLO: */lista*''', parse_mode="Markdown", reply_markup=markup)
        ...
        if message_with_inline_keyboard:
            msg_idf = telepot.message_identifier(message_with_inline_keyboard)
            markup = InlineKeyboardMarkup(inline_keyboard=[[dict(text='🔧suporte', url='https://telegram.me/robotaylor')],[InlineKeyboardButton(text='📃status', callback_data='n')]+[InlineKeyboardButton(text='⚙Comandos', callback_data='edit')]+[InlineKeyboardButton(text='ℹ', callback_data=' ')]])
            bot.editMessageText(msg_idf, '''
🤖*Informações do bot:*
➖➖➖➖➖➖➖➖➖
*bot*: `{}`
